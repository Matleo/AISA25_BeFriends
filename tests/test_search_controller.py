...
def test_handle_search_empty_query(
    controller, mock_search_service, mock_response_formatter, mock_telemetry
):
...
def test_handle_search_invalid_filters(
    controller, mock_search_service, mock_response_formatter, mock_telemetry
):
...
def test_handle_search_with_nonempty_result(
    controller, mock_search_service, mock_response_formatter, mock_telemetry
):
...
def test_handle_search_builds_query_and_calls_service(
    controller, mock_search_service, mock_response_formatter, mock_telemetry
):
    response = controller.handle_search("music", city="Berlin")
